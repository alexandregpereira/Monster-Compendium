...
class MonsterRegistrationStateRecoveryTest {
    ...
    fun `saveMetadata and getMetadata roundtrip preserves all list fields`() {
        ...
        val monster = buildMinimalMonster(index = "ancient-red-dragon").copy(
            ...
            specialAbilities = listOf(action.copy(id = "specialAbility-legendary-resistance")),
            reactions = listOf(action.copy(id = "reaction-tail-attack", abilityDescription = abilityDescription.copy(index = "reaction-one", name = "Tail Attack"))),
