...
internal data class MonsterRegistrationEnStrings(
    ...
    override val attackBonus: String = "Attack Bonus (Optional)",
    ...
    override val spells: String = "Spells (Legacy)",
    ...
    override val addSpellGroup: String = "Add spell group",
    override val removeSpellGroup: String = "Remove spell group",
...
internal data class MonsterRegistrationPtStrings(
    ...
    override val attackBonus: String = "Ataque Bônus (Opcional)",
    ...
    override val spells: String = "Magias (Legado)",
    ...
    override val addSpellGroup: String = "Adicionar grupo de magia",
    override val removeSpellGroup: String = "Remover grupo de magia",
...
internal data class MonsterRegistrationEsStrings(
    ...
    override val attackBonus: String = "Bonificador de Ataque (Opcional)",
    ...
    override val spells: String = "Conjuros (Legado)",
    ...
    override val addSpellGroup: String = "Añadir grupo de conjuro",
    override val removeSpellGroup: String = "Eliminar grupo de conjuro",
