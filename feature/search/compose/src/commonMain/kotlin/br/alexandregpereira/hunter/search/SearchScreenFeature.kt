...
fun SearchScreenFeature(
    ...
    SearchScreen(
        ...
        searchTipsTitle = state.searchTipsTitle,
        searchTips = state.searchTips,
        searchNoResultsTitle = state.searchNoResultsTitle,
        searchNoResultsDescription = state.searchNoResultsDescription,
