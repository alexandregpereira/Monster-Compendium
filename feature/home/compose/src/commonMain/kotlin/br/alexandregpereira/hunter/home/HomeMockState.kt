...
/**
 * The sections that are not connected to the domain yet.
 */
...
internal val homeMockFoldersSection: HomeSectionState.Folders =
    homeMockViewState.sections.filterIsInstance<HomeSectionState.Folders>().first()
