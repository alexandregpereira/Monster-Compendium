...
#ifndef AMPLITUDECORE_SWIFT_H
#define AMPLITUDECORE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AmplitudeCore",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
SWIFT_PROTOCOL_NAMED("CoreLogger")
...
typedef SWIFT_ENUM_NAMED(NSInteger, AMPCoreLogLevel, "LogLevel", open) {
  AMPCoreLogLevelOff = 0,
  AMPCoreLogLevelError = 1,
  AMPCoreLogLevelWarn = 2,
  AMPCoreLogLevelLog = 3,
  AMPCoreLogLevelDebug = 4,
};

SWIFT_CLASS("_TtC13AmplitudeCore18RemoteConfigClient") SWIFT_AVAILABILITY(tvos,introduced=13.0) SWIFT_AVAILABILITY(watchos,introduced=6.0) SWIFT_AVAILABILITY(ios,introduced=13.0) SWIFT_AVAILABILITY(macos,introduced=10.15)
@interface RemoteConfigClient : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

typedef SWIFT_ENUM_NAMED(NSInteger, AMPServerZone, "ServerZone", open) {
  AMPServerZoneUS = 0,
  AMPServerZoneEU = 1,
};
